%global git_short @@GIT_SHORT@@
%global git_date  @@GIT_DATE@@

Name:           fio
Version:        3.5
Release:        %{git_date}git%{git_short}%{?dist}
Summary:        Flexible I/O Tester

License:        GPL-2.0-only
URL:            https://github.com/PacheNico/fio
Source0:        %{name}-%{version}-%{git_short}.tar.gz
...
%prep
%setup -q -n %{name}-%{version}-%{git_short}
...
%changelog
* Mon Feb 23 2026 Nico Pache <npache@redhat.com> - 3.5
